...
# def shared(a, b)
#	elements = (a << b).flatten.uniq
#	p elements
#	elements.each do |i|
#		a.include? i || nil
#		b.include? i || nil
#			values.fill(true, values.size, 2)
#		elsif...
#			end
#		end
#	end
...
# Think this would have eventually worked but ran out of time, and seemed an inefficient way around. Solution below
